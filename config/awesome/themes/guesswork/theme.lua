---------------------------
-- guesswork awesome theme --
---------------------------

local theme_name                                = "guesswork"
...
local function wrap_widget(widget, bg, h_margin, v_margin)
    return wibox.widget {
        {
            {
...
theme.wallpaper_list                            = {
    wallpapers_dir .. "/wp12084793-rose-quartz-and-serenity-wallpapers.jpg",
    wallpapers_dir .. "/wp12084749-rose-quartz-and-serenity-wallpapers.jpg",
    wallpapers_dir .. "/wallhaven-kxd3j1.png",
}
...
theme.border_marked                             = COLORS.light_red
...
theme.tasklist_bg_focus                         = COLORS.light_red
...
--theme.clients_default_icon                      = theme.dir .. "/icons/clients/..."
theme.clients_icons                             = {
    ["Spotify"] = theme.dir .. "/icons/clients/spotify.svg",
    ["rhythmbox"] = theme.dir .. "/icons/clients/rhythmbox.svg",
    ["kitty"] = theme.dir .. "/icons/clients/PowerShell_5.0_icon.png",
...
local function create_media_player_widget()
    ...
    -- mpris widget args
    local mpris_widget_max_width = dpi(120)
    ...
    previous_button.font = "Vanilla Caramel 14"
    ...
    next_button.font = "Vanilla Caramel 14"
...
local function create_left_widgets(screen, widgets, w_taglist, w_promptbox)
    ...
    return wrap_top_widget({
        layout = wibox.layout.fixed.horizontal,
        spacing = GAPS_VALUE,
        wrap_widget(launcher_widget, nil, dpi(9), dpi(3)),
...
local function setup_wibar(s, layout, left_side, middle_side, right_side)
    ...
    s.mybottomwibox:setup {
        ...
        wibox.container.constraint(wrap_widget(s.mytasklist), "max", theme.tasklist_max_width),
        {
            layout = wibox.layout.fixed.horizontal
        }
    }
